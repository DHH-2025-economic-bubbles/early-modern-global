...
clusters_file = DATA_FOLDER / "articles_India/clustering_india.jsonl"
articles_file = DATA_FOLDER / "articles_India/articles_India_with_persons.jsonl"
output_file = DATA_FOLDER / "articles_India/india_clusters_with_texts.json"
...
for cluster_id, persons in clusters.items():
    ...
    if len(all_texts) > 10:
        ...
        sample_size = min(10, len(unique_texts))
